...
interface SidebarProps {
  ...
  setClickOutside: (arg: boolean) => void;
}
        ...
        icon: (
          ...
          >
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M4.25 4C4.25 3.58579 4.58579 3.25 5 3.25H19C19.4142 3.25 19.75 3.58579 19.75 4V20C19.75 20.4142 19.4142 20.75 19 20.75H5C4.58579 20.75 4.25 20.4142 4.25 20V4ZM5.75 4.75V19.25H18.25V4.75H5.75Z"
              fill=""
            />
            <path
              fillRule="evenodd"
            ...
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M7.25 15C7.25 14.5858 7.58579 14.25 8 14.25H12C12.4142 14.25 12.75 14.5858 12.75 15C12.75 15.4142 12.4142 15.75 12 15.75H8C7.58579 15.75 7.25 15.4142 7.25 15Z"
              fill=""
            />
          </svg>
        ),
...
const Sidebar = ({
  ...
  return (
    <>
      ...
      >
        <aside
          className={`sidebar absolute left-0 top-0 z-99 flex h-screen w-72.5 flex-col overflow-y-hidden border-r border-stroke bg-white transition-transform duration-300 ease-linear dark:border-stroke-dark dark:bg-gray-dark lg:static lg:translate-x-0 ${
       ...
       >
         ...
         >
          ...
          <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
            {/* <!-- Sidebar Menu --> */}
            <nav className="mt-7 px-4 lg:px-6">
